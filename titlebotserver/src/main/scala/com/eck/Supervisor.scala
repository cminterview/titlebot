...
final case class PageInfo(url: String, title: String, faviconUrl: String)
...
object Supervisor {
  ...
  final case class FetchPageInfoResponse(url: String, maybePageInfo: Option[PageInfo], router: ActorRef[GetPageInfoResponse]) extends Command
    ...
    Behaviors.setup[Command] { context =>
      ...
      Behaviors.receiveMessage {
        ...
        case FetchPageInfoResponse(url, maybePageInfo, router) =>
          context.log.info("checking fetched response")
          maybePageInfo match {
